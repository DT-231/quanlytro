...
export default function EditBuildingModal({
  ...
  useEffect(() => {
    if (buildingData && isOpen) {
      console.log("Data nhận được:", buildingData);
      ...
      if (
        parts.length > 0 &&
        parts[parts.length - 1].toLowerCase() === "vietnam"
      )
        parts.pop();
      ...
      if (!["ACTIVE", "INACTIVE", "SUSPENDED"].includes(currentStatus))
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      const streetLine = [values.houseNumber, values.street]
        .filter(Boolean)
        .join(" ");
              ...
              >
                ...
                <div className="mt-2 mb-3">
                  <AddressSelector
                    ...
                    onWardChange={(val) =>
                      form.setValue("ward", val, { shouldDirty: true })
                    }
                  />
                </div>
                ...
                <div className="pt-1">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1.5 text-black col-span-1"
                    >
                      <div className="h-3.5 w-3.5 border border-black rounded flex items-center justify-center">
                        <Plus size={10} />
                      </div>
                      <span className="text-xs font-bold">Thêm tiện ích</span>
                    </button>
                  </div>
                </div>
              </form>
