...
SEED_DATA_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'data', 'major_cities_buildings.json'))
...
def seed_buildings():
    ...
    print(f"Starting to seed {len(buildings)} buildings for major cities to {API_URL}...")
