...
from app.schemas.room_type_schema import (
    RoomTypeCreate, RoomTypeOut, RoomTypeUpdate, RoomTypeSimple
)
...
class RoomTypeService:
    ...
    def list_room_types_simple(self, is_active: bool = True, search: Optional[str] = None) -> List[RoomTypeSimple]:
    ...
    def delete_room_type(self, room_type_id: UUID, soft: bool = True) -> dict:
        ...
        if soft:
            ...
            message = f"Đã tạm ẩn loại phòng '{room_type.name}'"
        else:
